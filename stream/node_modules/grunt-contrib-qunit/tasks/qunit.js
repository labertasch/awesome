    ...
    if (options.httpBase) {
      ...
      if(options.httpBase instanceof Object) {
        ...
        if(!options.httpBase.host || !options.httpBase.doRewrite) {
            grunt.log.error("If you define httpBase as an object, you need define httpBase.host and callback function httpBase.rewrite");
        }
      ...
      this.filesSrc.forEach(function(testFile) {
        // if http base is an object check for server url and rewrite callback
        // return rewritten testfile
